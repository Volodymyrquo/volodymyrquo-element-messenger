...
import {toRem} from "matrix-react-sdk/src/utils/units";
...
import {E2E_STATE} from "./SumraE2EIcon";
import {WIDGET_LAYOUT_EVENT_TYPE} from "../../../stores/widgets/SumraWidgetLayoutStore";
import { hasText } from "../../../SumraTextForEvent"; 
...
export default class EventTile extends React.Component<IProps, IState> {
    ...
    render() {
        ...
        const ReplyThread = sdk.getComponent('views.elements.ReplyThread');
...
class E2ePadlock extends React.Component<IE2ePadlockProps, IE2ePadlockState> {
    ...
    render() {
        const Tooltip = sdk.getComponent('views.elements.Tooltip');
...
class SentReceipt extends React.PureComponent<ISentReceiptProps, ISentReceiptState> {
    ...
    render() {
        const NotificationBadge = sdk.getComponent('views.rooms.NotificationBadge');
