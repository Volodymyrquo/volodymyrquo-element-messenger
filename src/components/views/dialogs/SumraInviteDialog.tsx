...
import { CommunityPrototypeStore } from "../../../stores/SumraCommunityPrototypeStore";
import DMRoomMap from "matrix-react-sdk/src/utils/DMRoomMap";
import { RoomMember } from "matrix-js-sdk/src/models/room-member";
import SdkConfig from "matrix-react-sdk/src/SdkConfig";
import * as Email from "matrix-react-sdk/src/email";
import { getDefaultIdentityServerUrl, useDefaultIdentityServer } from "matrix-react-sdk/src/utils/IdentityServerUtils";
...
} from "../../../sumraCreateRoom";
import { inviteMultipleToRoom, showCommunityInviteDialog } from "../../../SumraRoomInvite";
...
import RoomListStore from "../../../stores/room-list/SumraRoomListStore";
...
import { copyPlaintext, selectText } from "matrix-react-sdk/src/utils/strings";
import { toRightOf } from "../../structures/SumraContextMenu";
import * as ContextMenu from "../../structures/SumraContextMenu";
    ...
    render() {
        ...
        const avatar = this.props.member.isEmail
            ? <img
                ...
                src={require("matrix-react-sdk/src/../res/img/icon-email-pill-avatar.svg")}
        ...
        if (this.props.onRemove) {
            closeButton = (
                ...
                >
                    <img src={require("matrix-react-sdk/src/../res/img/icon-pill-remove.svg")}
...
export default class SumraInviteDialog extends React.PureComponent<IInviteDialogProps, IInviteDialogState> {
    static replaces = "InviteDialog";
    static defaultProps = {
        kind: KIND_DM,
        initialText: "",
    };
    ...
    private onCopyClick = async e => {
        ...
        const GenericTextContextMenu = sdk.getComponent("views.context_menus.GenericTextContextMenu");
                ...
                if (visibility === "world_readable" || visibility === "shared") {
                    keySharingWarning =
                        <p className='mx_InviteDialog_helpText'>
                            <img
                                src={require("matrix-react-sdk/src/../res/img/element-icons/info.svg")}
                                width={14} height={14} />
