...
import TabbedView, { Tab } from "../../structures/SumraTabbedView";
...
export default class UserSettingsDialog extends React.Component<IProps, IState> {
    ...
    _getTabs() {
        ...
        const AppearanceUserSettingsTab = sdk.getComponent("views.settings.tabs.user.AppearanceUserSettingsTab")
        ...
        const MjolnirUserSettingsTab = sdk.getComponent( "views.settings.tabs.user.MjolnirUserSettingsTab");
