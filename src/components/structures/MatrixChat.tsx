...
import { MatrixClientPeg, IMatrixClientCreds } from "matrix-react-sdk/src/MatrixClientPeg";
import PlatformPeg from "matrix-react-sdk/src/PlatformPeg";
import SdkConfig from "matrix-react-sdk/src/SdkConfig";
import dis from "matrix-react-sdk/src/dispatcher/dispatcher";
import Notifier from '../../SumraNotifier';
import Modal from "matrix-react-sdk/src/Modal";
import * as sdk from 'matrix-react-sdk/src/index';
import { showRoomInviteDialog, showStartChatInviteDialog } from '../../SumraRoomInvite';
import * as Rooms from 'matrix-react-sdk/src/Rooms';
import linkifyMatrix from "matrix-react-sdk/src/linkify-matrix";
...
import { showToast as showNotificationsToast } from "../../toasts/SumraDesktopNotificationsToast";
import { OpenToTabPayload } from "matrix-react-sdk/src/dispatcher/payloads/OpenToTabPayload";
import { RoomNotificationStateStore } from "../../stores/notifications/SumraRoomNotificationStateStore";
import { SettingLevel } from "matrix-react-sdk/src/settings/SettingLevel";
import { leaveRoomBehaviour } from "../../utils/sumraMembership";
...
import SpaceStore from "../../stores/SumraSpaceStore";
        ...
        cli.on("crypto.keyBackupFailed", async (errcode) => {
            ...
            if (haveNewVersion) {
                Modal.createTrackedDialogAsync('New Recovery Method', 'New Recovery Method',
                    import('matrix-react-sdk/src/async-components/views/dialogs/security/NewRecoveryMethodDialog'),
                    { newVersionInfo },
                );
            } else {
                Modal.createTrackedDialogAsync('Recovery Method Removed', 'Recovery Method Removed',
                    import('matrix-react-sdk/src/async-components/views/dialogs/security/RecoveryMethodRemovedDialog'),
                );
            }
        });
