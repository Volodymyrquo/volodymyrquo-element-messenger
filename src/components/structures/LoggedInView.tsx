...
import { ToggleRightPanelPayload } from "matrix-react-sdk/src/dispatcher/payloads/ToggleRightPanelPayload";
import { IThreepidInvite } from "matrix-react-sdk/src/stores/ThreepidInviteStore";
import Modal from "matrix-react-sdk/src/Modal";
import { ICollapseConfig } from "matrix-react-sdk/src/resizer/distributors/collapse";
import { getKeyBindingsManager, NavigationAction, RoomAction } from 'matrix-react-sdk/src/KeyBindingsManager';
...
class LoggedInView extends React.Component<IProps, IState> {
    ...
    */
    ...
    render() {
        ...
        const CallContainer = sdk.getComponent("views.voip.CallContainer");
        const NonUrgentToastContainer = sdk.getComponent("structures.NonUrgentToastContainer");
        const HostSignupContainer = sdk.getComponent("views.host_signup.HostSignupContainer");
