...
import VoipUserMapper from './SumraVoipUserMapper';
import { ensureDMExists, findDMForUser } from './sumraCreateRoom';
import { addManagedHybridWidget, isManagedHybridWidgetEnabled } from './widgets/SumraManagedHybrid';
...
export default class CallHandler extends EventEmitter {
    ...
    private async placeCall(roomId: string, type: PlaceCallType, transferee: MatrixCall) {
        const DesktopCapturerSourcePicker = sdk.getComponent("views.elements.DesktopCapturerSourcePicker")
