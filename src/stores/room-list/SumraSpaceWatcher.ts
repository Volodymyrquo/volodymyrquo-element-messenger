...
import { RoomListStoreClass } from "matrix-react-sdk/src/stores/room-list/RoomListStore";
import SpaceStore, { UPDATE_SELECTED_SPACE } from "../SumraSpaceStore"; 
import { SpaceFilterCondition } from "./filters/SumraSpaceFilterCondition";
